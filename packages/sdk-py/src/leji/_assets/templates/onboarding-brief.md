<!-- Leji onboarding brief. Transient: written by `leji init`/`adopt` so an AI agent
     ...
     context. Once the layer is populated you may delete this file. It lives under a
     dot-directory so it is excluded from the index, the docs viewer, and the changelog. -->
